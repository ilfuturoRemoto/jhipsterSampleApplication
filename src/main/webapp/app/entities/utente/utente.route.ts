...
export class UtenteResolve implements Resolve<IUtente> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((utente: HttpResponse<Utente>) => utente.body);
        }
        return Observable.of(new Utente());
    }
}
...
export const utenteRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'jhipsterSampleApplicationApp.utente.home.title'
        },
